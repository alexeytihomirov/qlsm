...
class block(minqlx.Plugin):
    def __init__(self):
        ...
        self.add_hook("server_command", self.handle_server_command, priority=minqlx.PRI_LOWEST)
    ...
    def cmd_block(self, player, msg, channel):
        ...
        try:
            ...
            minqlx.get_logger(self).warning("block: sadd failed for %s: %s", player.steam_id, e)
    ...
    def cmd_unblock(self, player, msg, channel):
        ...
        try:
            ...
            minqlx.get_logger(self).warning("block: srem failed for %s: %s", player.steam_id, e)
    ...
    def _load_blocks(self, steam_id):
        ...
        try:
            ...
            minqlx.get_logger(self).warning("block: smembers failed for %s: %s", steam_id, e)
            return
