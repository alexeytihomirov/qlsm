...
itself lives in ui/instance_demo_transport.py, shared with any addon (e.g.
qlmatch-packer) that needs the same "open a session to this instance's demo
dir" mechanics for its own format-specific reads.
...
def fetch_instance_demos(instance_id, filenames):
    ...
    ui.instance_demo_transport.fetch_files for the return shape."""
