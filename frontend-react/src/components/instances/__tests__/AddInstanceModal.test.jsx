...
describe('AddInstanceModal draft handoff', () => {
  ...
  it('fetches the builtin preset details for both runtimes', async () => {
    ...
    // minqlxtended-patched has no builtin preset of its own -- it resolves to
    // the same 'default' (minqlx) preset as minqlx itself (see
    // defaultPresetNameForRuntime), so it seeds identically.
