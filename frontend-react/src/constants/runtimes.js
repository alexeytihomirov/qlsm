...
export const RUNTIME_OPTIONS = [
  ...
  },
  {
    ...
    description: "minqlxtended plus QLSM's own native patch chain (item events/respawn, demo capture, set_position). Shares minqlx's plugin pool. Built from a floating, unpinned commit — see docs/technical.md.",
    repoUrl: 'https://github.com/tjone270/minqlxtended',
  },
];
