...
from ui.runtime import MINQLX, MINQLXTENDED, MINQLXTENDED_PATCHED, normalize_runtime
...
_PATTERNS_BY_TARGET = {
    ...
    # The qlhub patch chain only adds native functions -- it does not remove or
    # rename anything in the Python-facing API, so the same removed-on-vanilla
    # patterns apply unchanged.
    MINQLXTENDED_PATCHED: _REMOVED_ON_MINQLXTENDED,
...
_EVENT_ARITY[MINQLXTENDED_PATCHED] = _EVENT_ARITY[MINQLXTENDED]
